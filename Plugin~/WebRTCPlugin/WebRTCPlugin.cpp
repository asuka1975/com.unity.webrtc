...
extern "C"
{
    ...
    UNITY_INTERFACE_EXPORT Context* ContextCreate(int uid, UnityEncoderType encoderType, bool useDirectAudio, bool forTest)
    {
        ...
        ctx = ContextManager::GetInstance()->CreateContext(uid, encoderType, useDirectAudio, forTest);
        return ctx;
    }
